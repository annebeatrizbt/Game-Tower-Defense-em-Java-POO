...
public class GerenciadorBlocos {
	...
	public ArrayList<Bloco> estradasS = new ArrayList<>();
	...
	private void criarBlocos() {
		...
		estradasS.add(ESTRADA_ESQ_DIR = new Bloco(getSprite(8, 0), id++, BLOCO_ESTRADA));
		estradasS.add(ESTRADA_CIMA_BAIXO = new Bloco(AjusteImg.getImgRotacionada(getSprite(8, 0), 90), id++, BLOCO_ESTRADA));
	...
	public ArrayList<Bloco> getEstradasS() {
		return estradasS;
	}
